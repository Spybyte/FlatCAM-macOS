...
from flatcam.cam.camlib import distance, arc, three_point_circle, Geometry, FlatCAMRTreeStorage
from flatcam.core.tool_base import AppTool
from flatcam.gui.elements import OptionalInputSection, FCCheckBox, FCLabel, FCComboBox, FCTextAreaRich, \
    FCDoubleSpinner, FCButton, FCInputDoubleSpinner, FCTree, NumericalEvalTupleEntry
from flatcam.parsers.font import *
    ...
    def get_pts(o):
        ...
        # Non-iterable
            ...
            if o is not None:
                ...
                elif type(o) == MultiPolygon:
                    for poly in o.geoms:
                        pts += DrawToolShape.get_pts(poly)
