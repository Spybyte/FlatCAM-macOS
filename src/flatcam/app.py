...
# Various
from flatcam.core.common import LoudDict
from flatcam.core.common import color_variant
from flatcam.core.common import ExclusionAreas

from flatcam.bookmark import BookmarkManager
from flatcam.core.database import ToolsDB2

from vispy.gloo.util import _screenshot
from vispy.io import write_png

# FlatCAM defaults (preferences)
from flatcam.defaults import FlatCAMDefaults

# FlatCAM Objects
from flatcam.gui.preferences.options_group_ui import OptionsGroupUI
from flatcam.gui.preferences.manager import PreferencesUIManager
from flatcam.objects.collection import *
from flatcam.objects.base import FlatCAMObj
from flatcam.objects.manager import AppObject

# FlatCAM Parsing files
from flatcam.parsers.excellon import Excellon
from flatcam.parsers.gerber import Gerber
from flatcam.cam.camlib import to_dict, dict2obj, ET, ParseError, Geometry, CNCjob

# FlatCAM appGUI
from flatcam.gui.canvas import *
from flatcam.gui.canvas_legacy import *
from flatcam.gui.main_window import *
from flatcam.gui.elements import FCFileSaveDialog, message_dialog, FlatCAMSystemTray, FCInputDialogSlider

# FlatCAM Pre-processors
from flatcam.core.preprocessor import load_preprocessors
...
from flatcam.editors.excellon_editor import AppExcEditor
from flatcam.editors.gerber_editor import AppGerberEditor
from flatcam.editors.text_editor import AppTextEditor
from flatcam.editors.gcode_editor import AppGCodeEditor
from flatcam.parsers.hpgl2 import HPGL2

# FlatCAM Workers
from flatcam.core.process import *
from flatcam.core.worker_stack import WorkerStack

# FlatCAM Tools
from flatcam.tools import *
...
class App(QtCore.QObject):
    ...
    def __init__(self, qapp, user_defaults=True):
        ...
        if sys.platform == 'win32':
            ...
            # #######################################################################################################
            config_file = os.path.join(str(_PROJECT_ROOT), 'config', 'configuration.txt')
            try:
            ...
            if portable is False:
                ...
                self.data_path = os.path.join(str(_PROJECT_ROOT), 'config')
        ...
        self.app_home = str(_PROJECT_ROOT)
        ...
        if self.is_legacy is False:
            ...
            from flatcam.gui.canvas_legacy import ShapeCollectionLegacy
    ...
    def copy_and_overwrite(from_path, to_path):
        ...
        try:
            ...
            from_new_path = os.path.join(str(_PROJECT_ROOT), 'src', 'flatcam', 'gui', 'VisPyData', 'data')
